...
describe('Handle sign in page functionality',function(){
    ...
    it('Enter Course name in the searchbox and click on coursemenu btn',function(){
        saplinglearning.verifyPopUpComing(saplinglearning.popUpSection,saplinglearning.closePopUp)
    ...
    it('Enter userid and password functionality',function(){
        ...
        saplinglearning.verifyMigrateToAchievePopupComing(saplinglearning.MigratePopup,saplinglearning.DoLater_btn)
        elementUtil.doScrollIntoViewPort(saplinglearning.reference)
        elementUtil.movetoElement(saplinglearning.course_Management)
        browser.pause(3000)
        elementUtil.movetoElement(saplinglearning.MigrateToAchieve)
        elementUtil.clickOnElement(saplinglearning.MigrateToAchieve)
        console.log('[Migrate To Achieve] is clicked successfully')
        elementUtil.waitForTitleToBeVisible()
